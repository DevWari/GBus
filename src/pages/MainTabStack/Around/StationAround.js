...
import Html from '../../Tmap/TmapAroundStation';
        ...
        <View style={styles.container}>
            {
                isVisible ?
                    ...
                    <View style={styles.detailBodyEmpty}>
                        <Text style={ConvStyle(15, Colors.fontColor, 170)}>500m 이내 정류소를 표시합니다.</Text>
                    </View>
            }
        </View>
    )
...
export default class StationAround extends Component {
    constructor(props) {
        super(props)
        this.state = {
            isVisible: false,
    ...
    render() {
        return (
            <SafeAreaView style={{ flex: 1 }}>
                <Header
                    centerComponent={{
                        text: this.props.route.params.data.stationName._text,
                ...
                <WebView
                    ...
                    onMessage={(event) => {
                        ...
                        if (data.isMarkerClick) {
                            ...
                            if (data.originalData == '1') {
                                ...
                                Alert.alert('오류', data.data, [{ text: '확인' }])
                            }
                        }
                    }}
                    ...
                    injectedJavaScript={
                        this.state.initialPosition != 'unknown' ?
                            `setLocation(${this.props.route.params.data.x._text}, ${this.props.route.params.data.y._text})` :
                            ``
                    }
                />
